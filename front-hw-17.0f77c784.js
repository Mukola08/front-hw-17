...
let searchValue = "";
function getApi() {
    return fetch(`https://newsapi.org/v2/everything?q=${searchValue}&from=2025-10-19&sortBy=publishedAt&apiKey=09de3f48ee0a4331be44f900830e74be&pageSize=3&page=${page}`).then((res)=>res.json());
}
...
function render(array) {
    const item = array.map(({ author, title, url, urlToImage })=>{
        return `
      <li class="js_item">
