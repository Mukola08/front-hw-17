...
let searchValue = "";
function getApi() {
    return fetch(`https://pixabay.com/api/?key=53352836-dad5189717df5eb8e42c0a0ba&q=${searchValue}&per_page=3&page=${page}`).then((res)=>res.json());
}
...
function render(array) {
    const item = array.map(({ user, tags, largeImageURL, pageURL })=>{
        return `
      <li class="js_item">
        <img src="${largeImageURL}" alt="${tags}" class="js_img">
        <h2 class="js_desc">${tags}</h2>
        <h3 class="js_title">\u{410}\u{432}\u{442}\u{43E}\u{440}: ${user}</h3>
        <a href="${pageURL}" class="js_link" target="_blank">\u{412}\u{456}\u{434}\u{43A}\u{440}\u{438}\u{442}\u{438}</a>
      </li>`;
    }).join("");
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire8a55", {})

//# sourceMappingURL=front-hw-17.0f77c784.js.map
